My vision is, to be able to distribute configuration as code    
  1 to servers      
    1 my own ones,
...
All common usable modules should be distributed under Apache2 Licence (maybe Eclipse Licence is also feasible).
